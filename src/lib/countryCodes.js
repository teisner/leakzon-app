// Comprehensive list of country calling codes with ISO codes for flag generation
// Flag emoji is generated from ISO code via isoToFlag()
...
export const COUNTRY_CODES = [
  ...
  { code: "599", country: "Curaçao", iso: "CW" },
...
export function findCountryByName(name) {
  ...
  return COUNTRY_CODES.find((c) => c.country.toLowerCase() === lower);
}

export function findCountryByCode(code) {
  return COUNTRY_CODES.find((c) => c.code === String(code));
}